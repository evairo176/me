...
const RU = {
  ...
  home: {
    personal: {
      ...
      description:
        "Я - Fullstack Developer в возрасте 23 лет с опытом работы более 1,5 лет. Мои навыки включают в себя разработку веб- и мобильных приложений с использованием React, TypeScript и Laravel. У меня сильный фокус на полном цикле разработки, начиная с дизайна интерфейса и заканчивая разработкой бэкэнда, что обеспечивает плавный и эффективный пользовательский опыт. С постоянным желанием учиться и внедрять инновации, я готов внести положительный вклад в проекты разработки программного обеспечения.",
